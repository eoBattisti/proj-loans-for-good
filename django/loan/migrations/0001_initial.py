    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated at')),
                ('descritpion', models.TextField(blank=True, null=True, verbose_name='Decription')),
                ('title', models.CharField(max_length=255, verbose_name='Title')),
                ('fields', models.ManyToManyField(blank=True, null=True, related_name='loan_forms', to='core.customfield', verbose_name='Fields')),
            ],
            options={
                'verbose_name': 'Loan Form',
                'verbose_name_plural': 'Loan Forms',
            },
        ),
    ]
